                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content centered">
                                    <h1 class="animation animated-item-1">mnbmb�</h1>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="carousel-content center centered">
                                    <h2 class="boxed animation animated-item-1">Мы работаем по всей Украине</h2>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <h5>
                                                    проект В-12-2(будет ссылка)
                                                </h5>
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="проект В-12-7" href="media/images/popular/3d.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="проект В-12-7" href="media/images/popular/dom.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="проект В-12-7" href="media/images/popular/dom2.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="проект В-12-7" href="media/images/popular/dom3.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="проект В-12-7" href="media/images/popular/dom4.jpg" rel="prettyPhoto"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xs-4">
                                        <div class="portfolio-item">
                                            <div class="item-inner">
                                                ...
                                                <div class="overlay">
                                                    <a class="preview btn btn-danger" title="проект В-12-7" href="media/images/popular/dom5.jpg" rel="prettyPhoto[gallery]"><i class="icon-eye-open"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
